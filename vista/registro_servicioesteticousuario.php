        ...
        <form action="" class="formulario" id="formulario">
            ...
            <div class="formulario__grupo" id="grupo__nombre">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="nombre" id="nombre" placeholder="Nombre de curso">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
                <p class="formulario__input-error">El Nombre de servicio estético solo puede contener letras y tiene que ser de 4 a 10 dígitos.</p>
            </div>
...
<br>
            ...
            <div class="formulario__grupo formulario__grupo-btn-enviar"><br><br>
<br>
...
<button type="submit" class="formulario__btn" style="float: left;"><a href="?pagina=registro_clientesusuario">Atrás</a> <i class="fas fa-arrow-left"></i></button>

<button type="submit" class="formulario__btn" style="float: right;"><a href="?pagina=registro_pagocitausuario">Siguiente </a> <i class="fas fa-arrow-right"></i></button>
