        ...
        <div class="wrapper">
            ...
            <div class="main-container">
                ...
                <form action=" " method="POST">
                     <input type="search" class="form-control" name="buscar" placeholder="Buscar en Estudiantes...">
            </div>
                ...
                <div class="card">
                    ...
                    <div class="row">
                        <h1 class="display-8 text-center p-2 text-white bg-secondary">Tabla Participante</h1>
                    </div>
