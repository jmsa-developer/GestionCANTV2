...
const expresiones = {
	...
	curso: /^[a-zA-ZÀ-ÿ\s]{1,25}$/, // Letras y espacios, pueden llevar acentos.
...
/*	usuario: /^[a-zA-Z0-9\_\-]{4,16}$/, // Letras, numeros, guion y guion_bajo
	curso: /^[a-zA-ZÀ-ÿ\s]{1,40}$/, // Letras y espacios, pueden llevar acentos.
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.curso && campos.duracion && campos.costo ){
		formulario.reset();
